...
Test pass:q[<u>underline *me*</u>] end test. Test2 pass:q[<u>*underline me*</u>] end test.

To perform operations related to printing you must be authenticated (logged in). 
You can only upload [underline]#*STL*# or <u>*G-Code*<u> files. Typically STL files have the extension <u>*.stl*<u> and G-code files 
